...
import numpy as np
import cv2
from retina_face.predict_single import Model
import torch
...
class FaceDetector():
    def __init__(self, device='cuda:0',
        ...
        if model_path:
            ...
            model = load_net_param(model, model_path, device)
            self.model = model
            self.model.eval()
    ...
    def detect(self, image):
        ...
        return success, cropped, bbox, landmark, score
