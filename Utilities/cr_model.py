...
class IResNet(nn.Module):
    ...
    def __init__(self,
                 ...
                 groups=1, width_per_group=64, replace_stride_with_dilation=None, fp16=False,use_se=False, qs=1, fix_qs=False):
        ...
        # The regression layer used by fitting fixed-quality scores
        if self.fix_qs:
        ...
        # The regression layer used by fitting dynamic-quality scores
        else:
